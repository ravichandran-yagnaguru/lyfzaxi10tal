...
TOPICS = [
    ...
    {"id": "ctrl_z", "category": "trivia", "prompt": "Ctrl+Z (undo) and how software actually keeps track of everything you've done so it can reverse it", "image_type": "photo", "photo_keywords": "keyboard keys closeup", "photo_subject": "keyboard"},
